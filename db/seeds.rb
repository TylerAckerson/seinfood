MenuItem.create!([
  ...
  {name: "\tGeneral Tso Chicken\t", description: "\tWith steamed mixed vegetables and white riceWith steamed mixed vegetables and white rice\t", category: "\tChicken\t", restaurant_id: 2, archived: false, price: 7.0},
  {name: "\tEgg Rolls\t", description: "\tMany flavors\t", category: "\tSides\t", restaurant_id: 2, archived: false, price: 4.0},
  {name: "\tSpring Rolls\t", description: "\tMany flavors\t", category: "\tSides\t", restaurant_id: 2, archived: false, price: 3.0},
  {name: "\tCrab Rangoon\t", description: "\tCrab flavored\t", category: "\tSides\t", restaurant_id: 2, archived: false, price: 3.5},
  {name: "\tSoup\t", description: "\tEgg drop or miso\t", category: "\tSides\t", restaurant_id: 2, archived: false, price: 2.3},
  {name: "\tKung Pao Chicken\t", description: "\tVery spice!\t", category: "\tChicken\t", restaurant_id: 2, archived: false, price: 8.0},
  {name: "\tTeriyaki Chicken\t", description: "\tWith steamed mixed vegetables and white rice\t", category: "\tChicken\t", restaurant_id: 2, archived: false, price: 9.0},
  {name: "\tOrange Chicken\t", description: "\tFried with orange sauce\t", category: "\tChicken\t", restaurant_id: 2, archived: false, price: 11.0},
  {name: "\tMu Shu Pork\t", description: "\tMmmmmm\t", category: "\tPork\t", restaurant_id: 2, archived: false, price: 11.0},
  {name: "\tSzechuan Pork\t", description: "\tMmmmmm\t", category: "\tPork\t", restaurant_id: 2, archived: false, price: 12.0},
  {name: "\tBBQ Beef\t", description: "\tMmmmmm\t", category: "\tBeef\t", restaurant_id: 2, archived: false, price: 9.0},
  {name: "\tBeef Teriyaki\t", description: "\tMmmmmm\t", category: "\tBeef\t", restaurant_id: 2, archived: false, price: 8.0},
  {name: "\tKung Pao Beef\t", description: "\tMmmmmm\t", category: "\tBeef\t", restaurant_id: 2, archived: false, price: 8.0},
  {name: "\tPeppered Beef\t", description: "\tMmmmmm\t", category: "\tBeef\t", restaurant_id: 2, archived: false, price: 9.0},
...
Restaurant.create!([
  ...
  {name: "Soup Stand", cuisine: "Soups", address: "259-A West 55th Street", city: "New York City", state: "NY", yelp_id: nil, opens_at: 1100, closes_at: 1800, delivery_min: 5, delivery_fee: 0.0, takeout_only: true, image_link: "https://dl.dropboxusercontent.com/u/4448887/seinfood/3.jpg"},
  ...
  {name: "Pomodoro Roso", cuisine: "Italian", address: "229 Columbus Ave", city: "New York City", state: "New York", yelp_id: nil, opens_at: 1300, closes_at: 2300, delivery_min: 5, delivery_fee: 0.0, takeout_only: true, image_link: "https://dl.dropboxusercontent.com/u/4448887/seinfood/5.jpg"},
  {name: "Paisano", cuisine: "Italian", address: "2287 1st Ave\t1100", city: "New York City", state: "New York", yelp_id: nil, opens_at: 1100, closes_at: 2200, delivery_min: 5, delivery_fee: 0.0, takeout_only: true, image_link: "https://dl.dropboxusercontent.com/u/4448887/seinfood/6.jpg"},
  ...
  {name: "Hunan 5th Avenue", cuisine: "Chinese", address: "323 5th Ave", city: "New York City", state: "New York", yelp_id: nil, opens_at: 1100, closes_at: 2200, delivery_min: 5, delivery_fee: 0.0, takeout_only: true, image_link: "https://dl.dropboxusercontent.com/u/4448887/seinfood/8.jpg"},
  ...
  {name: "Mendy's", cuisine: "Deli", address: "61 E. 64th Street", city: "New York City", state: "New York", yelp_id: nil, opens_at: 1030, closes_at: 2200, delivery_min: 12.0, delivery_fee: 3, takeout_only: false, image_link: "https://dl.dropboxusercontent.com/u/4448887/seinfood/10.jpg"},
  ...
  {name: "Pete's Tavern", cuisine: "American", address: "129 E. 18th St", city: "New York City", state: "New York", yelp_id: nil, opens_at: 1100, closes_at: 2300, delivery_min: 5, delivery_fee: 0.0, takeout_only: true, image_link: "https://dl.dropboxusercontent.com/u/4448887/seinfood/13.jpg"},
  ...
  {name: "Fitzpatrick's Bar and Grill", cuisine: "American", address: "1641 Second Ave", city: "New York City", state: "New York", yelp_id: nil, opens_at: 1200, closes_at: 2300, delivery_min: 5, delivery_fee: 0.0, takeout_only: true, image_link: "https://dl.dropboxusercontent.com/u/4448887/seinfood/16.jpg"}
])
User.create!([
...
MenuItem.create!(	{name: "	Chicken Fingers	", description: "	With Fries and a pickle	", category: "	Lunch	", restaurant_id:	16	 , archived:	FALSE	, price: 	8	});
MenuItem.create!(	{name: "	Hamburger	", description: "	Quarter pounder with fries and a pickle	", category: "	Lunch	", restaurant_id:	16	 , archived:	FALSE	, price: 	9	});
MenuItem.create!(	{name: "	Chicken Sandwich	", description: "	With lettuce and tomato	", category: "	Lunch	", restaurant_id:	16	 , archived:	FALSE	, price: 	8	});
MenuItem.create!(	{name: "	Tacos	", description: "	3, chicken or beef	", category: "	Lunch	", restaurant_id:	16	 , archived:	FALSE	, price: 	9	});
MenuItem.create!(	{name: "	Chicken Fingers	", description: "	With Fries and a pickle	", category: "	Late Night	", restaurant_id:	16	 , archived:	FALSE	, price: 	6	});
MenuItem.create!(	{name: "	Hamburger	", description: "	Quarter pounder with fries and a pickle	", category: "	Late Night	", restaurant_id:	16	 , archived:	FALSE	, price: 	7	});
MenuItem.create!(	{name: "	Chicken Sandwich	", description: "	With lettuce and tomato	", category: "	Late Night	", restaurant_id:	16	 , archived:	FALSE	, price: 	6	});
MenuItem.create!(	{name: "	Tacos	", description: "	3, chicken or beef	", category: "	Late Night	", restaurant_id:	16	 , archived:	FALSE	, price: 	7	});															
